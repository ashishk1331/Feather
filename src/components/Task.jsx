...
export default function Task(props) {
	...
	return (
		<motion.li
			layoutId={props.id}
			className={twMerge(
				"relative flex items-center gap-2 w-full justify-between p-3 border-2 rounded-lg my-4 bg-white dark:bg-gray-900",
				selected
		...
		>
								...
								<p
									...
									className={twMerge(
										...
										finished && props.menuOption === 0
											...
											: "bg-slate-blue/50 px-1.5 dark:text-gray-900"
									)}
								>
									{i.substring(1)}
								</p>
			...
			{props.liked && (
				<div
					className={twMerge(
						"p-2 rounded-full absolute -top-2 -left-2 bg-white dark:bg-gray-900 border-2 border-slate-blue",
						selected
							? "border-black dark:border-white"
							: "dark:border-gray-800"
					)}
