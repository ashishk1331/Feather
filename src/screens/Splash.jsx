...
export default function Splash(props){
	...
	return (
			splashScreen && <div className="w-screen min-h-screen absolute top-0 left-0 flex items-center bg-white dark:bg-gray-900 dark:text-white z-[99]">
				<div className="m-auto flex flex-col items-center gap-8">
					...
					<div className="w-[250%] h-1 rounded-full bg-gray-200 dark:bg-gray-600 overflow-hidden">
						<motion.div 
							...
							exit={{ opacity: 0 }}
							className="w-12 h-1 bg-black dark:bg-white" 
						/>
					</div>
				</div>
			</div>
